...
public class DiscountTest {
    ...
    void setUp() throws Exception{
        ...
        inv1.addToCategory("Electronics",2);
        inv1.addToCategory("Laptops",2);
...
//        categoryDiscountSetup();
    ...
    public void tenPercentDiscountOver200() throws Exception {
        ...
        DiscountDataObject discount = new DiscountDataObject(10, AbstractDiscount.discountTypes.Product,0,"",new ArrayList<>(Arrays.asList(predicate)));
        ...
        Order or1 = new OrderController().createNewOrder(worker,cart, storeCtrl.calculatePrice(cart),storeCtrl :: setPrices);
        assertEquals(s1.handleDiscount(or1),120);
        cart.addProductToCart(0,new ProductInfo(0,inv1.getProduct(2),1),1);
        or1 = new OrderController().createNewOrder(worker,cart, storeCtrl.calculatePrice(cart),storeCtrl :: setPrices);
    ...
    public void xorLogicalCompositeTest() throws Exception {
        ...
        Order order = new OrderController().createNewOrder(worker,cart,storeCtrl.calculatePrice(cart),storeCtrl :: setPrices);
    ...
    public void andLogicalCompositeTest() throws Exception{
        ...
        DiscountDataObject dis1 = new DiscountDataObject(10, AbstractDiscount.discountTypes.Product,0,"",new ArrayList<>(Arrays.asList(pred1)));
        PredicateDataObject pred2 = new PredicateDataObject(DiscountPredicate.PredicateTypes.MinNumOfItem,"2 2",null);
        DiscountDataObject dis2 = new DiscountDataObject(10, AbstractDiscount.discountTypes.Product,2,"",new ArrayList<>(Arrays.asList(pred2)));
        ...
        Order or = new OrderController().createNewOrder(worker,cart,storeCtrl.calculatePrice(cart),storeCtrl::setPrices);
        assertEquals(240,s1.handleDiscount(or)); //no discount because it doesnt uphold all predicates

        cart.addProductToCart(0,new ProductInfo(0,inv1.getProduct(0),1),1);
        or = new OrderController().createNewOrder(worker,cart,storeCtrl.calculatePrice(cart),storeCtrl::setPrices);
    ...
    public void orLogicalCompositeTest() throws Exception{
        ...
        DiscountDataObject dis1 = new DiscountDataObject(10, AbstractDiscount.discountTypes.Category,0,"Bananas",new ArrayList<>(Arrays.asList(pred1)));
        PredicateDataObject pred2 = new PredicateDataObject(DiscountPredicate.PredicateTypes.MinNumOfItem,"1 2",null);
        DiscountDataObject dis2 = new DiscountDataObject(10, AbstractDiscount.discountTypes.Category,1,"Bananas",new ArrayList<>(Arrays.asList(pred2)));
