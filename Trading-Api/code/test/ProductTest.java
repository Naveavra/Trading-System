...
public class ProductTest {
    ...
    {
        Product p = new Product(1,"Watermelon","7kg of pure,red, juicy love that will never betray you.");
        p.setQuantity(5);
    ...
    {
        Product p = new Product(1,"Avocado","Weird green sphere that everyone seems to pretend that they love.");
    ...
    void testSetPrice_ValidInput() throws Exception {
        Product p = new Product(1,"Steak","A fine piece of meat filled with the blood of your enemies.");
        p.setPrice(20);
