...
//            purchases.addAll(new PurchaseInfo( ((OrderInfo)res.getValue()).getProductsInStores() ));
//            return purchases;
//        }
//        return null;
//    }
...
//        Response<HashMap<Integer, HashMap<Integer, HashMap<Integer, Integer>>>> res = market.getUsersPurchaseHistory(user, token);
//        if(!res.errorOccurred())
//        {
